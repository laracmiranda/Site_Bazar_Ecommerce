...
import { Home, Package, ShoppingBag, LogOut, Mail } from 'lucide-react'; // opcional, ícone
...
export default function Navbar() {
  ...
  //py-4 px-6 md:px-30 flex justify-between items-center
